...
public class ManejadoraDeDatos {
    ...
    private void procesarCadena() {
    	usuarios = new ColeccionUsuarios(); // Reiniciar la colecci�n de usuarios si ya se hab�a cargado antes
        ...
        // Iteramos desde i = 1 para saltar encabezados o t�tulo
        for (int i = 1; i < filas.length; i++) {
            String fila = filas[i].trim();

            // Si la fila est� vac�a, no procesamos
            ...
            // Si la primera celda no parece una fecha v�lida (dd/MM/yyyy), salteamos
            ...
            try {
                ...
                // Asociamos el pr�stamo al usuario
        ...
        // Imprimir cu�ntos usuarios se importaron al final
